...
<div class="container">
 <header>
    <div class="logo" style="width:33%;"><img class="mylogo" src="images/eventureLogo.png"></div>
    <div class="title" align="center"> Eventure </br>
            ...
            <form action="merchantRequestProcessor" method="post" accept-charset="ISO-8859-1" autocomplete="off" id="paymentForm">
	            <div>
	            	<div class="wd-100 two-div">
	            			<!-- <input class="textbox" type="hidden" name="merchantId" id="merchantId" value="M00005008" >
	                		<input class="textbox" type="hidden" name="apiKey" id="apiKey" value="Kl0gy6mt0gz2EE6fh8rq3fD6Ae5uB0dL" > -->
	            			<input class="textbox" type="hidden" name="merchantId" id="merchantId" value="M00096" >
	                		<input class="textbox" type="hidden" name="apiKey" id="apiKey" value="Mc1gR6Ul1uw0Qp0jN1Sg4Qf2eq6CN6Yc" >
	            ...
	            <div class="mt-20">
	            	<!-- <a href="downloadFile?merchant=M00005008" target="_blank">Terms and Conditions</a> -->
	            	<a href="downloadFile?merchant=M00096" target="_blank">Terms and Conditions</a>
	            </div>
            </form>
    </div>
    </div>
