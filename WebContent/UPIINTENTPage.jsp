        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col-md-6 lft_logo">
                     <img onclick="BackButton();" id="payBack" style="filter:  brightness(0) invert(1);" height='30' src="assets/images/back.svg" />
               </div>
            </div>
        </div>
    </header>
    ...
    <section class="payment">
                ...
                <FORM ACTION="" id="MyForm1" name="MyForm1" METHOD='POST'>
                    ...
                    <input type="hidden" id="respData" name="respData" value="">
                        ...
                        <div class="container container-mobile card">
                        <div class="fix_btn card-body row ">                    
    					<div class="col" style="margin-top: 1%;">
    					
         			         <a href="#newModal" id="modal" data-bs-toggle="modal" data-bs-target="#newModal"
                            style="font-size: 14px;color:#0d6efd!important;text-decoration:none">
                            Payment summary
                             </a>
                             </div>                                             
                            <div class="col">                           
                             <button  onclick="hideButton();"   id="payWithUPIURL"
                                        type="button" class="btn btn-primary" >                                
                                    <a style="font-size: 14px;color:white;text-decoration:none;" id="payWithUPI" href="<%=QrUrl%>">
                                    ...
                                    <div class="loading-wrapper-mobile" style="display:flex">
                                        <div class="lading-graph-wrapper-mobile">
                                            <div id="countdownMobile" style="margin-right: -6px; margin-left:25px">
                                                ...
                                                <svg class="mobile" style="margin-top: -20%">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="model-header-text text-lg-center" style="color: #004a97">Payment Summary</h3>
                                <a href="#" class="close close-btn" data-bs-dismiss="modal"
                                   style="color:#A8A8A8" id="modalClose">&#10006</a>
                            </div>
                            <div class="modal-body text-start body-text-modal" style="font-size: 15px;font-family: 'Lato', sans-serif;width: 100%;">
...
<!--         <a  target="dummyframe" href="upi://pay?pa=EPAISAA@rbl&pn=rewardoo&mc=1506&tr=101444401001&tn=Pay&am=10.00&cu=INR&mam=10&refUrl=&sign=MEUCIQCA1utL2VrrkjRD0OOCJU74WmFY//OzbRiKFIBVhTe9KQIgA8vtA1XH7007E08ZjJu7yxclzKCn+InJtCZ8G2QJBgE=" hidden> <button  hidden id='paynow'>Pay Now</button> </a>
 -->  
<%--  <form method="post"   id="payForm"  name="payForm" action="<%=QrUrl%>">
                                       <!--  <input type="hidden" id="respDataID" name="respData" value="">
                                        <input type="hidden" id="merchantId" name="merchantId" value="">
                                        <input ty
                                        pe="hidden" id="pgid" name="pgid" value=""> -->
                                    </form> --%>
                                    
    <!-- SOF BTN -->
    <footer>
        <p>2022-23 All rights reserved</p>
    </footer>
</div>
...
if (performance.navigation.type == performance.navigation.TYPE_RELOAD) {
  ...
  console.info( "This page is not reloaded");
        ...
        function BackButton() {
	debugger
	/* alert("Enter in Back Button"); */
	<%-- swal({
		  title: 'Are you sure?',
		  text: "You want to cancel transaction !",
		  type: 'warning',
	...
	swal({
	      ...
	      if (isConfirm) {
	    	  <%
			     String mmerchantRefNo = (String)session.getAttribute("merchantRefNo"); // merchant transaction id column name txn_id in transaction_master
			     String mmTrackId = (String)session.getAttribute("MTrackid"); // our transaction id column name id in transaction_master
			     String aamount = (String)session.getAttribute("amt");

			     System.out.println("merchantRefNo ====="+mmerchantRefNo +"mTrackId========"+mmTrackId + "amount==========="+aamount );
			     %>
			    $.ajax
			    ({
			        type: 'POST',
			        data: {mTrackId: '<%=mmTrackId%>', merchantRefNo: '<%=mmerchantRefNo%>', amount: '<%=aamount%>'},
			        url: "<%=request.getContextPath()%>/ajaxAction?type=BackButton",
...
function hideButton() {
    var button = document.getElementById("payWithUPIURL");
    
  var back=  document.getElementById("payBack");
...
'</div>';
    ...
    function startTimer() {
        ...
        timerInterval = setInterval(() => {
            ...
            if(timeLeft === 299)
            	{
//document.getElementById("payWithUPI").click();
//initiateUPIPayment();
}
count++;
