...
<div class="container">
 <header>
    <div class="logo"><img class="mylogo" src="images/logo-earnmore.png"></div>
    <div class="title" align="center"> Earn-More </br>
            ...
            <form action="merchantRequestProcessor" method="post" accept-charset="ISO-8859-1" autocomplete="off" id="paymentForm">
	            <div>
	            	<div class="wd-100 two-div">
	            			<input class="textbox" type="hidden" name="merchantId" id="merchantId" value="M00082" >
	                		<input class="textbox" type="hidden" name="apiKey" id="apiKey" value="Nb0Xj4Bl1Qa6XG5Za6Cf9fc4eB5aJ5BT" >
	            		...
	            		<div class="wd-50">
	            			...
	            			<div>
	            				<input class="textbox no-margin"type="text" name="udf1" id="udf1" value="" maxlength="50">
	            			</div>
	            	...
	            	<div class="wd-100 two-div">
	            		<div class="wd-50 mr-20">
		            		...
		            		<div>
		            			<input class="textbox no-margin" type="text" name="amount" id="amount" style="border-radius: 5px;" value="5.50" readonly>
		            		</div>
		            	</div>
		            	<div class="wd-50">
		            		<div class="label-padding">
					...
					<input class="textbox1"type="hidden" name="returnURL" id="returnURL" value="https://domain/merchantResponse.jsp">
	            ...
	            <div class="mt-20">
	            	<a href="downloadFile?merchant=M00082" target="_blank">Terms and Conditions</a>
	            </div>
            </form> 
    </div>	
    </div>
        <div class="footer-div">
        	<div>
        		<a href="http://seal.panaceainfosec.com/index.php?certid=CERTFE0E982CCB">
      				<img class="pci-logo" src="images/pci-logo1.png">
      			</a>
        	</div>
        	...
        	<div>
        		<a href="https://pay.in/">
					<img class="pay-logo" src="images/Powered-by-.png">
				</a>
        	</div>
		</div>
 <script>
...
function validateDetails(e) {
	try{
		  ...
		  var custName = document.getElementById("udf1").value;
		  ...
		  if(custMobile==null || custMobile=="") {
			  ...
			  document.getElementById("amount").value="5.50";
			  return false;
		  }else{
			  var earnMoreType = "earn-more2";
			  document.getElementById("udf2").value=earnMoreType;
			  isLimitBreached(earnMoreType);
		  }
		}catch(err) {
			alert(err);
		}
	...
	function isLimitBreached(earnMoreType){
		$.ajax ({		
			type: 'POST',
		    data: {link :earnMoreType, merchantId : document.getElementById("merchantId").value},
	    ...
	    $.ajax ({				
			...
			success: function(result) {
				if(result != null && result !="") {
					...
					document.getElementById("udf1").value=obj.pincode;
