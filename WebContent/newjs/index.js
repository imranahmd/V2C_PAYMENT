...
$(document).ready(function () {
    ...
    function checkCardType() {
       ...
       //alert("CardType For Logo : "+cardType+" ");   // BHARAT
        ...
        switch (cardType) {
            case 'Visa':
                $('#card-image').html('<img src="newjs/visa.svg" height="100%">');
            ...
            case 'MasterCard':
                $('#card-image').html('<img src="newjs/master.svg" height="100%">');
                ...
                break;
            case 'Discover':
                $('#card-image').html('<img src="newjs/discover.svg" height="100%">');
            ...
            case 'American Express':
                $('#card-image').html('<img src="newjs/american.svg" height="100%">');
                ...
                break;
             case 'Diners Club':
                $('#card-image').html('<img src="newjs/dinner.svg" height="100%">');
                break;
                // bharat  Discover
             case 'Rupay':
                 $('#card-image').html('<img src="newjs/rupay.svg" height="100%">');
                 break;
                 
             case 'Maestro':
                 $('#card-image').html('<img src="newjs/maestro.png" height="100%">');
                 break; 
                 
             case 'Unknown': 
                 $('#card-image').html('<img src="newjs/other.svg" height="100%">');
                 break;   
...
$(document).ready(function () {
    ...
    function checkCardType() {
        ...
        switch (cardType) {
            case 'Visa':
                $('#card-image1').html('<img src="newjs/visa.svg" height="100%">');
            ...
            case 'MasterCard':
                $('#card-image1').html('<img src="newjs/master.svg" height="100%">');
                ...
                break;
            case 'Discover':
                $('#card-image1').html('<img src="newjs/discover.svg" height="100%">');
            ...
            case 'American Express':
                $('#card-image1').html('<img src="newjs/american.svg" height="100%">');
                ...
                break;
             case 'Diners Club':
                $('#card-image1').html('<img src="newjs/dinner.svg" height="100%">');
                break;
             case 'Rupay':
                 $('#card-image1').html('<img src="newjs/rupay.svg" height="100%">');
                 break;
...
$(document).ready(function () {
    ...
    function checkCardType() {
        ...
        switch (cardType) {
            case 'Visa':
                $('#card-image2').html('<img src="newjs/visa.svg" height="100%">');
            ...
            case 'MasterCard':
                $('#card-image2').html('<img src="newjs/master.svg" height="100%">');
                ...
                break;
            case 'Discover':
                $('#card-image2').html('<img src="newjs/discover.svg" height="100%">');
            ...
            case 'American Express':
                $('#card-image2').html('<img src="newjs/american.svg" height="100%">');
                ...
                break;
             case 'Diners Club':
                $('#card-image2').html('<img src="newjs/dinner.svg" height="100%">');
                break;
             case 'Rupay':
                 $('#card-image2').html('<img src="newjs/rupay.svg" height="100%">');
                 break;
...
$(document).ready(function () {
    ...
    function checkCardType() {
        ...
        switch (cardType) {
            case 'Visa':
                $('#card-image3').html('<img src="newjs/visa.svg" height="100%">');
            ...
            case 'MasterCard':
                $('#card-image3').html('<img src="newjs/master.svg" height="100%">');
                ...
                break;
            case 'Discover':
                $('#card-image3').html('<img src="newjs/discover.svg" height="100%">');
            ...
            case 'American Express':
                $('#card-image3').html('<img src="newjs/american.svg" height="100%">');
                ...
                break;
             case 'Diners Club':
                $('#card-image3').html('<img src="newjs/dinner.svg" height="100%">');
                break;
             case 'Rupay':
                 $('#card-image3').html('<img src="newjs/rupay.svg" height="100%">');
                 break;
