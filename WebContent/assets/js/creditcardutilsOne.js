...
/*
  ...
  URL: https://github.com/faaez/creditcardutilsOne
...
(function() {
  ...
  (function(name, definition) {
  ...
  })('creditcardutilsOne', function() {
    var cardFromNumber, cardFromType, creditcardutilsOne, defaultFormat, formatBackCardNumber, formatBackExpiry, formatCardExpiry, formatCardNumber, formatForwardExpiry, formatForwardSlashAndSpace, hasTextSelected, luhnCheck, reFormatCVC, reFormatCardNumber, reFormatExpiry, replaceFullWidthChars, restrictCVC, restrictCardNumber, restrictExpiry, restrictNumeric;
    creditcardutilsOne = {};
    defaultFormat = /(\d{1,4})/g;
    creditcardutilsOne.cards = [
      {
        type: 'visaelectron',
    ...
    reFormatCardNumber = function(e) {
      ...
      e.target.value = creditcardutilsOne.formatCardNumber(e.target.value);
    ...
    reFormatExpiry = function(e) {
      var cursor;
      cursor = _getCaretPos(e.target);
      e.target.value = creditcardutilsOne.formatCardExpiry(e.target.value);
      if ((cursor != null) && e.type !== 'change') {
        return e.target.setSelectionRange(cursor, cursor);
      }
    };
    ...
    creditcardutilsOne.parseCardExpiry = function(value) {
    ...
    creditcardutilsOne.validateCardNumber = function(num) {
      var card, ref;
      num = (num + '').replace(/\s+|-/g, '');
      if (!/^\d+$/.test(num)) {
        return false;
    ...
    creditcardutilsOne.validateCardExpiry = function(month, year) {
    ...
    creditcardutilsOne.validateCardCVC = function(cvc, type) {
      var card, ref;
      cvc = String(cvc).trim();
      if (!/^\d+$/.test(cvc)) {
        return false;
    ...
    creditcardutilsOne.parseCardType = function(num) {
      var ref;
      if (!num) {
        return null;
      }
    ...
    creditcardutilsOne.formatCardNumber = function(num) {
    ...
    creditcardutilsOne.formatCardExpiry = function(expiry) {
