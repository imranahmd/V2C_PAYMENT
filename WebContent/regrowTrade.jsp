...
<%
	Logger log = LoggerFactory.getLogger("JSPS.regrowTrade.jsp");
...
<head>
<title>RegrowTrade : Payment</title>
<!-- for-mobile-apps -->
...
<div class="container">
 <header>
    <div class="logo" style="width: 27%;"><img class="mylogo" src="images/Regrow-Trade_Brand_Logo.png"></div>
    <div class="title" align="center">REGROW TRADE </br>
            ...
            <form action="merchantRequestProcessor" method="post" accept-charset="ISO-8859-1" autocomplete="off" id="paymentForm">
	            <div>
	            	<div class="wd-100 two-div">
	            			<input class="textbox" type="hidden" name="merchantId" id="merchantId" value="M0009w" >
	                		<input class="textbox" type="hidden" name="apiKey" id="apiKey" value="rx0ro9lo0bR3DG7hr5Gu4JC5XC4xl7Wm" >
...
<!-- 					<input class="textbox1"type="hidden" name="returnURL" id="returnURL" value="https://ppvas.Epaisaapg.in/pppayfiVAS/merchantResponse.jsp">
 -->					<input class="textbox1"type="hidden" name="returnURL" id="returnURL" value="https://pay.Epaisaapg.in/payment/merchantResponse.jsp">
	            ...
	            <div class="mt-20">
	            	<a href="downloadFile?merchant=M00005006" target="_blank">Terms and Conditions</a>
	            </div>
            </form> 
    </div>	
    </div>
        <div class="footer-div">
        	...
        	<div>
        		<a href="https://Epaisaa.in/">
					<img class="Epaisaa-logo" src="images/Powered-by-logo.png">
				</a>
        	</div>
		</div>
 <script>
...
function validateDetails(e) {
	try{
		  ...
		  if(custMobile==null || custMobile=="") {
			  ...
			  return false;
		  }else if(custMail != null && custMail != "" && !regex.test(custMail)) {
