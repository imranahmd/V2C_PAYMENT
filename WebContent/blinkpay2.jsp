...
<%
	Logger log = LoggerFactory.getLogger("JSPS.blinkpay2.jsp");
	            ...
	            <div>
	            	<div class="wd-100 two-div">
	            	    <!--     <input class="textbox" type="hidden" name="merchantId" id="merchantId" value="M0002" >
	                		...
	                		<input class="textbox" type="hidden" name="apiKey" id="apiKey" value="FI4bP0hr9hB3yJ1ns9Sk2jS1Kz0Do9HR" >
	            	...
	            	<div class="wd-100 two-div">
	            		<div class="wd-50 mr-20">
		            		...
		            		<div>
		            			<input class="textbox no-margin" type="text" name="amount" id="amount" value="50.00" style="border-radius: 5px;" readonly>
		            		</div>
		            	</div>
		            	<div class="wd-50">
		            		<div class="label-padding">
