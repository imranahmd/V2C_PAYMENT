...
(function () {
    ...
    if (
        ...
        (h = !!/stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0)),
        (f = "console" in window && "warn" in window.console),
        (e = function () {
            var a;
        ...
        !h &&
            ...
            f &&
            ((l = document.querySelectorAll('script[src^="' + n + '"]')), l.length || console.warn("It looks like Stripe.js is not being loaded from https://js.stripe.com. Stripe does not support serving Stripe.js from your own domain.")),
        (a = (function () {
            function a() {
        ...
        if (3 !== this.Stripe.version)
            return !f || this.Stripe.isDoubleLoaded || this.Stripe.earlyError || console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page."), void (this.Stripe.isDoubleLoaded = !0);
        ...
        this.Stripe = a,
            ...
            this.Stripe.card = (function (b) {
                ...
                return (
                    ...
                    (c.createToken = function (b, d, f) {
                        var g, h, i;
                        if ((null == d && (d = {}), a.token.validate(b, "card"), "function" == typeof d ? ((f = d), (d = {})) : "object" != typeof d && ((g = parseInt(d, 10)), (d = {}), g > 0 && (d.amount = g)), b._fields && b.createToken))
                            return b.createToken(f);
                        (d[c.tokenName] = a.token.formatData(b, c.whitelistedAttrs)), (d.time_on_page = Math.round(e() - m));
                        try {
                            (i = Object.keys(k)), i.length > 0 && (d.pasted_fields = i.sort().join(","));
                        } catch (j) {
                            h = j;
                        }
                    ...
                    (c.cardType = function (a) {
                        return c.cardTypes[a.slice(0, 3)] ||c.cardTypes[a.slice(0, 2)]|| "Unknown";
                    }),
                    ...
                    (c.cardTypes = (function () {
                        ...
                        for (a = d = 51; d <= 59; a = ++d) b[a] = "MasterCard";
                        for (a = d = 22; d <= 27; a = ++d) b[a] = "MasterCard";
                        return (
                            (b[34] = b[37] = "American Express"),
                            (b[62] = b[64] = "Discover"),
                            (b[50] = b[63] = b[67] = b[68] = b[69] = "Maestro"),
                            (b[60] = b[60] = b[65] = b[508] = "Rupay"),
                            (b[35] = "JCB"),
            ...
            d = ["createToken", "getToken", "cardType", "validateExpiry", "validateCVC", "validateCardNumber"],
            o = 0,
            p = d.length;
        o < p;
        o++
    )
        (i = d[o]), (this.Stripe[i] = this.Stripe.card[i]);
    if (((this.Stripe.stripejs_ua = "stripe.js/4bb95a3"), !this.Stripe._isChannel && true))
        try {
            "function" == typeof window.addEventListener &&
                window.addEventListener(
                    ...
                    function (b) {
                        ...
                        if (null == a.StripeV3 && !a.isDoubleLoaded) {
                            ...
                            return "m" === c.originatingScript && /stripe\.com$/.test(b.origin) ? (a.__sid = c.payload) : void 0;
                        }
                    },
                    !1
                ),
                (j = !1),
                (b = function () {
                    var b, c, d, e, f, g, i, k, l, m, n, o, p, q, r, s;
                    try {
                        if (null != a.StripeV3 || a.isDoubleLoaded || j) return;
                        (j = !0), (q = document.location.href), (l = null);
                        try {
                            if (((k = document.querySelector("meta[name=referrer]")), null != k))
                                switch ((l = null != (s = k.content) ? s.toLowerCase() : void 0)) {
                                    case "origin":
                                    case "strict-origin":
                        ...
                        (f = /checkout\.stripe\.com$/.test("undefined" != typeof window && null !== window ? window.location.host : void 0)),
                            (c = { referrer: document.referrer, title: document.title, url: q, muid: a.utils.getMerchantID(), sid: a.utils.getSessionID(), preview: h && !f }),
                            null != l && (c.metaReferrerPolicy = l),
                            (e = "#");
                        for (m in c) (r = c[m]), (e += "" + m + "=" + encodeURIComponent(r) + "&");
                        (i = document.createElement("iframe")),
                            (i.src = "https://js.stripe.com/v2/m/outer.html" + e),
                            ...
                            setInterval(function () {
                                ...
                                if (((c = window.location.href), c !== n)) {
                                    try {
                                        (d = JSON.stringify({ action: "ping", sid: a.utils.getSessionID(), muid: a.utils.getMerchantID(), referrer: n, url: c, title: document.title })), i.contentWindow.postMessage(d, "*");
                                    } catch (e) {
                                        b = e;
                                    }
                                    return (n = c);
                    ...
                    return (
                        (p = function (b, c) {
                            var d;
                            return (d = JSON.stringify({ action: "track", sid: a.utils.getSessionID(), muid: a.utils.getMerchantID(), url: window.location.href, source: b, data: c })), i.contentWindow.postMessage(d, "*");
                        }),
                        (g = []),
                        (o = new Date()),
                        (d = function () {
                ...
                return (
                    ...
                    (b.setCookie = function (a, b, c) {
                        ...
                        return (
                            ...
                            (d = "" + encodeURIComponent(a) + "=" + b + ";expires=" + e.toGMTString() + ";path=" + c.path),
                    ...
                    (b.getSessionID = function () {
                        var a, b, c;
                        try {
                            return (b = this.getCookie("__stripe_sid") || this.generateID()), (c = { domain: "." + document.location.hostname, expiresIn: 18e5 }), this.setCookie("__stripe_sid", b, c), b;
                        } catch (d) {
                            return (a = d), "NA";
                        }
                    }),
            ...
            this.Stripe.isDoubleLoaded ||
                (this.Stripe.ajaxJSONP = function (c) {
                    ...
                    return (
                        ...
                        (d = function (a) {
                            var b;
                            return null == a && (a = "abort"), clearTimeout(e), null != (b = i.parentNode) && b.removeChild(i), f in window && (window[f] = function () {}), "function" == typeof c.complete ? c.complete(a, k, c) : void 0;
                        }),
                        (k = { abort: d }),
                        (i.onerror = function () {
                            return k.abort(), "function" == typeof c.error ? c.error(k, c) : void 0;
                        }),
                        (window[f] = function () {
                            var a, d;
                            ...
                            return "function" == typeof c.success && c.success.apply(c, b.call(a).concat([k])), "function" == typeof c.complete ? c.complete("success", k, c) : void 0;
                        }),
                        (h = (c.headers || {})["Accept-Language"]),
                        (j = (c.headers || {})["Stripe-Account"]),
                        c.data || (c.data = {}),
                        (c.data.callback = f),
                        c.method && (c.data._method = c.method),
                        h && (c.data._accept_language = h),
                        j && (c.data._stripe_account = j),
                        (i.src = c.url + "?" + Stripe.utils.serialize(c.data)),
                        (g = document.getElementsByTagName("head")[0]),
                        g.appendChild(i),
                        c.timeout > 0 &&
                            (e = setTimeout(function () {
                                return k.abort("timeout");
                            }, c.timeout)),
                        k
                    );
                });
